...
?>
        ...
        <div class="col-lg-9 col-md-8 col-sm-8">
            ...
            <?php
include('php/RequetesGenre.php');
while ($donnees = $titregenre->fetch())
{
?>
                <div class="titre"><?php echo $donnees['Type_Genre']; ?></div><br />
                <?php   
    }
$titregenre->closeCursor(); // on ferme la boucle et termine le traitement de la requete pour le titre du GENRE
?>
                <?php
                include('php/RequetesGenre.php');
while ($donnees = $affichesgenre->fetch())
{
?>
